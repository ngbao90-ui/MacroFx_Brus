...
<div class="narrative-panel">
  ...
  <div class="narrative-body">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ...
      <div style="background:#27272a;border-radius:8px;padding:8px 10px">
        <div style="font-size:10px;font-weight:600;color:#f87171;margin-bottom:3px">🇨🇦 CAD Structural Weakness</div>
      ...
      <div style="background:#27272a;border-radius:8px;padding:8px 10px">
        <div style="font-size:10px;font-weight:600;color:#93c5fd;margin-bottom:3px">🇦🇺 RBA Hawkish vs AUD Crowded</div>
      ...
      <div style="background:#27272a;border-radius:8px;padding:8px 10px">
        <div style="font-size:10px;font-weight:600;color:#6ee7b7;margin-bottom:3px">🇬🇧 BoE July 30 Live Meeting</div>
  ...
  <div class="section-content" id="heatmap">
    <div class="heatmap">
      ...
      <div class="hm-card">
        ...
        <div class="hm-score red">5.0</div>
    ...
    <div id="cross-pairs" style="display:none">
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="ej">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>DE10Y (~2.45%) > JP10Y (~2.60%) → spread ~+25bp nghiêng EUR. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> theo nhịp BoJ hike tiếp tục</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="eg">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>GB10Y (~4.48%) >> DE10Y (~2.45%) → spread ~+-189bp nghiêng GBP. <span class="spread-tag spread-widen">↗ Giãn rộng</span> khi USD tăng kéo DE yield theo</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="ec">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>DE10Y (~2.45%) < CA10Y (~3.42%) → spread ~-97bp bất lợi EUR về yield. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> khi CA yield yếu theo dầu giảm</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="es">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>DE10Y (~2.45%) >> CH10Y (~0.39%) → spread ~+246bp nghiêng EUR. <span class="spread-tag spread-widen">↗ Giãn rộng</span> sau ECB hike, SNB giữ nguyên</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="gj">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>GB10Y (~4.48%) >> JP10Y (~2.60%) → spread ~+214bp nghiêng GBP. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> theo nhịp BoJ hike tiếp tục</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="gc">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>GB10Y (~4.48%) > CA10Y (~3.42%) → spread ~+136bp nghiêng GBP. <span class="spread-tag spread-widen">↗ Giãn rộng</span> theo dầu giảm kéo CA yield</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="gs">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>GB10Y (~4.48%) >> CH10Y (~0.39%) → spread ~+435bp nghiêng GBP. <span class="spread-tag spread-widen">↗ Giãn rộng</span> — CHF yếu sau peace deal, BoE giữ hawkish</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="ac">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>AU10Y (~4.78%) > CA10Y (~3.42%) → spread ~+135bp nghiêng AUD. <span class="spread-tag spread-widen">↗ Giãn rộng</span> theo dầu giảm kéo CA yield</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="as">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>AU10Y (~4.78%) >> CH10Y (~0.39%) → spread ~+434bp — LỚN NHẤT toàn dashboard. <span class="spread-tag spread-widen">↗ Giãn rộng</span> (CHF yếu, AU yield neo cao)</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="aj">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>AU10Y (~4.78%) >> JP10Y (~2.60%) → spread ~+213bp nghiêng AUD. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> từ từ theo BoJ hike tiếp</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="nj">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>NZ10Y (~4.39%) >> JP10Y (~2.60%) → spread ~+179bp nghiêng NZD. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> theo nhịp BoJ hike</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="nc">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>NZ10Y (~4.39%) > CA10Y (~3.42%) → spread ~+101bp nghiêng NZD. <span class="spread-tag spread-widen">↗ Giãn rộng</span> theo dầu giảm kéo CA yield</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="ns">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>NZ10Y (~4.39%) >> CH10Y (~0.39%) → spread ~+400bp nghiêng NZD. <span class="spread-tag spread-widen">↗ Giãn rộng</span> (CHF yếu sau peace deal)</div>
      ...
      <div class="pair-row">
        <button class="pair-btn" style="background:rgba(248,113,113,0.05)" onclick="togglePair('cj')">
        ...
        <div class="pair-detail" id="cj">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>CA10Y (~3.42%) > JP10Y (~2.60%) → spread ~+78bp nghiêng CAD. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> mạnh theo BoJ hike + dầu giảm kéo CA yield</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="sj">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>CH10Y (~0.39%) < JP10Y (~2.60%) → spread ~-221bp bất lợi CHF. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> (BoJ hike → JP10Y tăng, CHF yield neo thấp)</div>
      ...
      <div class="pair-row">
        ...
        <div class="pair-detail" id="sc">
          ...
          <div style="margin-top:5px"><span class="pair-detail-label">Bond Yield: </span>CA10Y (~3.42%) >> CH10Y (~0.39%) → spread ~+299bp nghiêng CAD. <span class="spread-tag spread-narrow">↘ Thu hẹp</span> (CA yield giảm theo dầu)</div>
...
<div class="section" id="sec-cot">
  ...
  <div class="section-content" id="cot" style="display:none">
    <div class="cot-note">CFTC <b style="color:#e4e4e7">Traders in Financial Futures (TFF)</b> — Futures Only · Cutoff: 23/6/2026 · Release: 27/6/2026. Nguồn: <b style="color:#a1a1aa">CFTC.gov</b> dea/futures/financial_lf.htm. <b style="color:#d4d4d8">Dealer/Intermediary</b>: sell-side (hedge client risk) · <b style="color:#d4d4d8">Asset Manager</b>: pension/mutual funds — dòng tiền dài hạn · <b style="color:#d4d4d8">Leveraged Funds</b>: hedge funds/CTAs — speculative smart money. So sánh 2 kỳ 23/6 vs 16/6 để lấy hướng dòng tiền. Z-score từ net position Non-Commercial Legacy làm baseline. Không dùng để timing — chỉ xác nhận/cảnh báo.</div>

    <div class="cot-card">
      <div class="cot-head">
        <span style="font-size:16px">🇺🇸</span>
        <span style="font-weight:700;color:#fafafa;font-size:13px">USD Index</span>
        <span style="font-size:11px;background:#14532d;color:#86efac;border-radius:4px;padding:2px 7px">LF Net-Long đỉnh 15 tuần</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-long">+34,278 net long</span> · AM và LF đồng thuận long USD · Xác nhận narrative hawkish Fed · Z=+1.8 lệch rõ nhưng chưa cực đoan — còn room tăng thêm nếu NFP beat</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#1a3a20;color:#6ee7b7;border-radius:4px;padding:2px 7px">AM Long đang phân kỳ với LF</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-long">+239,320 net long</span> — nhưng <b style="color:#fca5a5">cả AM và LF đều đang TĂNG SHORT</b> · AM đang unwind long dần · LF đã flip bearish · Z=+1.4 đang giảm dần — rủi ro EUR long unwind lớn nếu EURUSD phá 1.13</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#7f1d1d;color:#fca5a5;border-radius:4px;padding:2px 7px">LF Extreme Short — Dealer Counter</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-short">−175,456 net short EXTREME</span> · LF short JPY −97K là nhóm nguy hiểm nhất · Dealer đang net LONG +118K = hedge client risk · Z=−2.3 cực đoan · USDJPY 161.74 — bất kỳ BoJ surprise hoặc MoF intervention = short-squeeze dữ dội · STOP RỘNG mọi cặp JPY</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#1e3a5f;color:#93c5fd;border-radius:4px;padding:2px 7px">AM vs Dealer: Chiến tranh vị thế</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-short">−141,857 net short</span> — AM đang BET GBP YẾU mạnh (+32K short) · Dealer counter với +55K long · LF trung lập · Phân kỳ lớn giữa sell-side (bullish GBP) và buy-side (bearish) · BoE 30/7 sẽ phân giải — CPI Anh 15/7 là data quan trọng nhất</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#4a1d60;color:#d8b4fe;border-radius:4px;padding:2px 7px">Đã flip Net-Short (Legacy Z: −0.3)</span>
        <span class="cot-zscore zscore-neutral">Z: −0.3</span>
      </div>
      <div class="cot-group-row">
        <div class="cot-group-box">
          <div class="cot-group-label">Dealer</div>
          <div class="cot-group-net flow-neutral">N/A</div>
      ...
      <div class="cot-buyside">Legacy Non-Commercial: <span class="flow-short">−13,012 net short</span> · ĐÃ ĐẢO CHIỀU từ extreme long (Z=+2.6) xuống net short (Z=−0.3) trong 2 tuần · Change: Long −2.1K, Short +6.7K · AUD không còn crowded long — rủi ro unwind đã được giải phóng phần lớn · AUDUSD 0.6887 — CPI Q2 29/7 sẽ quyết định hướng tiếp theo</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#4a1d60;color:#d8b4fe;border-radius:4px;padding:2px 7px">Net-short 6-week high</span>
      ...
      <div class="cot-buyside">Legacy Non-Commercial: <span class="flow-short">−37,000 net short</span> · 6-week high short · Short tăng 4 tuần liên tiếp — thị trường đang bet NZD yếu · RBNZ 8/7 là binary event: nếu hike 25bp → short-squeeze NZD mạnh; nếu hold → short tăng thêm · Z=−1.1 chưa cực đoan — còn room tiếp tục nếu RBNZ dovish</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#78350f;color:#fcd34d;border-radius:4px;padding:2px 7px">LF+AM đồng thuận short — mạnh nhất</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-short">−167,245 net short</span> · LF tăng short +18K tuần — ACCELERATION bearish · AM và LF đồng thuận short CAD mạnh nhất nhóm · Dealer hedge client net long · Z=−1.6 tiến gần extreme · USDCAD 1.4191 — BoC MPR 15/7 là catalyst cắt giảm tiếp theo · Target 1.43-1.45</div>
    </div>
    ...
    <div class="cot-card">
      <div class="cot-head">
        ...
        <span style="font-size:11px;background:#4a1d60;color:#d8b4fe;border-radius:4px;padding:2px 7px">AM+LF cùng short, tích lũy dần</span>
      ...
      <div class="cot-buyside">Buy-side (AM+LF): <span class="flow-short">−53,585 net short</span> · AM và LF cùng build short CHF sau peace deal · Dealer hedge net long · Z=−1.2 chưa cực đoan — còn dư địa short CHF tiếp tục · USDCHF 0.8098 — yield spread +399bp khổng lồ hỗ trợ USDCHF tăng · Safe haven premium tiếp tục fade</div>
    </div>
...
<!-- CURRENCY CARDS -->
<div style="font-size:13px;font-weight:600;color:#d4d4d8;margin-bottom:10px">Chi Tiết Từng Đồng Tiền (sắp xếp theo điểm tổng hợp)</div>
...
<div class="cur-card">
  ...
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">4.35%</b> · Giữ nguyên 16/6/2026 sau 3 hike liên tiếp Feb-Mar-May</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Lao động: </span>Thất nghiệp 4.5% (tháng 4) — việc làm giảm 18,600 — bắt đầu yếu dần</div>
  </div>
  <div class="cur-body" id="aud">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">10-11/8/2026</span>Họp RBA + SoMP — quyết định lãi suất tiếp theo</div>
      <div style="margin-top:3px"><span class="upcoming-date">20/8/2026</span>Labor tháng 7 — xác nhận xu hướng thị trường lao động</div>
    </div></div>
    ...
    <div class="history-list">
      <div class="history-item"><span class="history-date">2026-02-10:</span> <span class="history-score green">6.5</span> — RBA hike lần 1 (25bp lên 3.85%) — mở đầu chu kỳ thắt chặt</div>
      <div class="history-item"><span class="history-date">2026-04-08:</span> <span class="history-score green">7.4</span> — RBA hike lần 2 lên 4.10% — thất nghiệp giảm xuống 4.1%</div>
...
<div class="cur-card">
  ...
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">3.50%–3.75%</b> · Giữ nguyên 12-0 tại phiên họp đầu của Warsh (17/6/2026)</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Lao động: </span>NFP +172K tháng 5 (vượt xa dự báo 85K), thất nghiệp 4.3%, lương +3.4% YoY</div>
  </div>
  <div class="cur-body" id="usd">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">14/7/2026</span>CPI tháng 6 — xác nhận tariff inflation narrative — quyết định hướng FOMC tháng 7</div>
      <div style="margin-top:3px"><span class="upcoming-date">28-29/7/2026</span>Họp FOMC — 62% định giá hike tháng 9, 80% hike tháng 12</div>
    </div></div>
    <div class="secondary-box">
    ...
    <div class="history-list">
      ...
      <div class="history-item"><span class="history-date">2026-06-05:</span> <span class="history-score green">7.0</span> — CPI 4.2% + NFP +172K — củng cố lo ngại lạm phát trước FOMC</div>
      <div class="history-item"><span class="history-date">2026-06-17:</span> <span class="history-score green">7.3</span> — FOMC dot-plot đảo hawkish (3.4%→3.8%), phiên đầu Warsh — USD tăng mạnh</div>
      <div class="history-item"><span class="history-date">2026-06-26:</span> <span class="history-score green">7.3</span> — PCE tháng 5 in-line (4.1%/3.4%) — hike Sep 62-63%, DXY nhẹ về 101.1 — score giữ nguyên</div>
    </div></div>
    <div class="meta-grid">
...
<div class="cur-card">
  <button class="cur-head" onclick="toggleCur('jpy')">
    ...
    <div class="cur-scores">
      ...
      <div class="cur-sub-scores">M:7.2 S:5.0</div>
      <div class="score-bar"><div class="score-bar-fill" style="width:66%;background:#facc15"></div></div>
    </div>
    <span style="color:#71717a;font-size:12px;margin-left:6px">▼</span>
  </button>
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">1.00%</b> · Tăng +25bp 7-1 (16/6/2026) — cao nhất từ 1995</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Lao động: </span>Lương Shunto tăng bền vững — điều kiện bình thường hóa đã đáp ứng</div>
  </div>
  <div class="cur-body" id="jpy">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">25/7/2026</span>CPI toàn quốc Nhật tháng 6</div>
      <div style="margin-top:3px"><span class="upcoming-date">30-31/7/2026</span>Họp BoJ — Tamura ủng hộ hike tiếp, target 1.25-1.50%?</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Safe Haven (đang suy yếu sau peace deal)<span style="color:#facc15;margin-left:8px">5.5/10</span></div>
    ...
    <div class="history-list">
      ...
      <div class="history-item"><span class="history-date">2026-06-16:</span> <span class="history-score green">7.0</span> — BoJ tăng 25bp lên 1.00%, Tamura ủng hộ hike tiếp tục</div>
...
<div class="cur-card">
  <button class="cur-head" onclick="toggleCur('eur')">
    ...
    <div class="cur-scores">
      <div class="cur-main-score red">5.0</div>
      <div class="cur-sub-scores">M:5.2 S:4.5</div>
      <div class="score-bar"><div class="score-bar-fill" style="width:50%;background:#f87171"></div></div>
    </div>
    <span style="color:#71717a;font-size:12px;margin-left:6px">▼</span>
  </button>
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">2.25% (deposit)</b> · Tăng +25bp lần đầu từ 2023 (11/6/2026)</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Tăng trưởng: </span>GDP 2026 dự báo 0.8% — Germany PMI tháng 6 vẫn thu hẹp</div>
  </div>
  <div class="cur-body" id="eur">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">23/7/2026</span>Họp ECB — guidance hậu hike, dầu hạ có làm ECB bớt hawkish?</div>
      <div style="margin-top:3px"><span class="upcoming-date">30/7/2026</span>GDP Eurozone Q2 sơ bộ</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Năng lượng nhập khẩu (lực kéo âm)<span style="color:#f87171;margin-left:8px">4.2/10</span></div>
    ...
    <div class="history-list">
      ...
      <div class="history-item"><span class="history-date">2026-06-11:</span> <span class="history-score green">7.0</span> — ECB tăng 25bp lên 2.25% — lần đầu từ 2023</div>
...
<div class="cur-card">
  <button class="cur-head" onclick="toggleCur('gbp')">
    ...
    <div class="cur-scores">
      ...
      <div class="cur-sub-scores">M:6.1 S:5.0</div>
      <div class="score-bar"><div class="score-bar-fill" style="width:58%;background:#facc15"></div></div>
    </div>
    <span style="color:#71717a;font-size:12px;margin-left:6px">▼</span>
  </button>
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">3.75%</b> · Giữ nguyên 7-2 (18/6/2026) — 2 phiếu muốn tăng lên 4%</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Services: </span>3.7% tháng 5 — thứ MPC theo dõi sát nhất — vẫn cứng đầu</div>
  </div>
  <div class="cur-body" id="gbp">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">16/7/2026</span>Báo cáo lao động Anh tháng 5</div>
      <div style="margin-top:3px"><span class="upcoming-date">30/7/2026</span>Họp MPC + MPR — 'Genuinely live meeting'</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Năng lượng + Services cứng đầu<span style="color:#f87171;margin-left:8px">4.5/10</span></div>
    ...
    <div class="cur-section"><div class="cur-section-title">📈 Score History</div>
    <div class="history-list">
      <div class="history-item"><span class="history-date">2026-01-15:</span> <span class="history-score yellow">5.0</span> — BoE giữ nguyên — lạm phát quanh mục tiêu, trung lập</div>
...
<div class="cur-card">
  <button class="cur-head" onclick="toggleCur('chf')">
    ...
    <div class="cur-scores">
      ...
      <div class="cur-sub-scores">M:4.2 S:3.0</div>
      <div class="score-bar"><div class="score-bar-fill" style="width:38%;background:#f87171"></div></div>
    </div>
    <span style="color:#71717a;font-size:12px;margin-left:6px">▼</span>
  </button>
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">0.00%</b> · Giữ nguyên (18/6/2026) — bỏ tham chiếu rủi ro Trung Đông</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Safe Haven: </span>CHF +12% vs USD trong 2025 nhờ dòng vốn trú ẩn — nay đang suy yếu</div>
  </div>
  <div class="cur-body" id="chf">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">18/9/2026</span>Họp SNB tiếp theo</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Safe Haven đang mất lực<span style="color:#f87171;margin-left:8px">3.2/10</span></div>
    ...
    <div class="cur-section"><div class="cur-section-title">📈 Score History</div>
    <div class="history-list">
      <div class="history-item"><span class="history-date">2026-03-02:</span> <span class="history-score green">7.2</span> — Chiến tranh Iran — CHF tăng vọt nhờ dòng vốn trú ẩn</div>
      <div class="history-item"><span class="history-date">2026-06-18:</span> <span class="history-score yellow">5.0</span> — SNB bỏ tham chiếu Trung Đông — báo hiệu safe haven premium suy yếu</div>
      <div class="history-item"><span class="history-date">2026-06-23:</span> <span class="history-score red">4.5</span> — MOU Mỹ-Iran làm CHF mất lực đỡ chính, USD mạnh do Warsh/FOMC hawkish</div>
    </div></div>
  </div>
</div>
...
<div class="cur-card">
  <button class="cur-head" onclick="toggleCur('cad')">
    ...
    <div class="cur-scores">
      ...
      <div class="cur-sub-scores">M:3.8 S:3.0</div>
      <div class="score-bar"><div class="score-bar-fill" style="width:35%;background:#f87171"></div></div>
    </div>
    <span style="color:#71717a;font-size:12px;margin-left:6px">▼</span>
  </button>
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">2.25%</b> · Giữ nguyên lần 5 liên tiếp (10/6/2026)</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Kinh tế: </span>GDP Q1 âm -0.1% annualized — thất nghiệp 6.5-7.0% — technical recession</div>
  </div>
  <div class="cur-body" id="cad">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">15/7/2026</span>BoC MPR — cập nhật dự báo tăng trưởng và lạm phát</div>
      <div style="margin-top:3px"><span class="upcoming-date">9/9/2026</span>Họp BoC tiếp theo — có thể đổi hướng chính sách</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Giá dầu (Petro-currency)<span style="color:#f87171;margin-left:8px">3.5/10</span></div>
    ...
    <div class="cur-section"><div class="cur-section-title">📈 Score History</div>
    <div class="history-list">
      <div class="history-item"><span class="history-date">2026-03-15:</span> <span class="history-score yellow">5.2</span> — Chiến tranh Iran đẩy dầu lên — CAD hưởng lợi tạm thời</div>
...
<div class="cur-card">
  ...
  <div class="cur-summary">
    <div class="cur-rate"><span style="color:#71717a">Lãi suất: </span><b style="color:#e4e4e7">2.25%</b> · Giữ nguyên lần 3 liên tiếp (29/5/2026) — MPC split 3-3, Breman casting vote</div>
    ...
    <div style="font-size:12px;color:#a1a1aa;margin-top:4px"><span style="color:#71717a">Tăng trưởng: </span>GDP Q1/2026: +0.8% q/q (miss vs dự báo) · NZIER downgrade 2026 xuống 0.6% · Consumer confidence 80.4 (thấp nhất từ 2023)</div>
  </div>
  <div class="cur-body" id="nzd">
    ...
    <div style="font-size:12px;color:#a1a1aa">
      ...
      <div style="margin-top:3px"><span class="upcoming-date">16/7/2026</span>CPI Q2/2026 NZ — dự báo tăng mạnh về 4.0-4.3% (đỉnh chu kỳ)</div>
      <div style="margin-top:3px"><span class="upcoming-date">2/9/2026</span>Họp RBNZ — MPS đầy đủ với dự báo mới</div>
    </div></div>
    <div class="secondary-box">
      <div class="secondary-title">🔍 Stagflation Risk + Dairy/Commodity<span style="color:#facc15;margin-left:8px">4.5/10</span></div>
    ...
    <div class="history-list">
      ...
      <div class="history-item"><span class="history-date">2026-02-18:</span> <span class="history-score yellow">4.8</span> — RBNZ hold, OCR track shift hawkish — tín hiệu hike cuối năm</div>
      ...
      <div class="history-item"><span class="history-date">2026-06-24:</span> <span class="history-score yellow">5.2</span> — GDP Q1 miss + NZIER downgrade + consumer confidence đáy — NZD yếu; dầu giảm hạ peak CPI</div>
    </div></div>
    <div class="meta-grid">
